...
- [Proofyard for AI Agents](docs/how-to/proofyard-for-ai-agents.md)
...
- **Current public packet order**
  ...
  - the Proofyard MCP install skill is the cleaner public packet today
...
- **Publish-ready but not yet published**:
  `@proofyard/mcp-server`, the Proofyard MCP install skill, and the
