        ...
        <Card className="launch-hero-card">
          <CardContent className="launch-hero-grid p-4">
            <div className="launch-hero-copy">
              <p className="launch-hero-kicker">{t("Webaudit Command Center")}</p>
          ...
          <div className="templates-grid">
            ...
            <Card className="template-card">
              ...
              <p className="template-meta">
                ...
                {t(
                  "Use it when the agent shell should stay external and Webaudit should stay the browser-evidence substrate."
                )}
              </p>
              <div className="mt-3">
                <Button
