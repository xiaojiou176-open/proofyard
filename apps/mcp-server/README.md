...
`apps/mcp-server` is the **governed MCP side road** for Webaudit.
...
contract**.
It is not proof that Webaudit already has a published registry package,
...
- Webaudit remains the browser automation, retained evidence, and recovery
  substrate
...
[Webaudit for Coding Agents and Agent Ecosystems](../../docs/how-to/webaudit-for-coding-agents.md).
...
Use this order if you are integrating Webaudit into another agent stack:
...
- it expects a mounted Webaudit checkout (or another compatible workspace
