# Webaudit for Coding Agents and Agent Ecosystems
...
Webaudit is not trying to replace your coding agent shell.
...
Use Webaudit when your coding agent still needs a browser lane, but you do
...
- Webaudit records what happened in the browser lane
- the retained run becomes something you can inspect, compare, and hand off

## Truthful ecosystem fit matrix

Webaudit does **not** claim first-party Codex-native, Claude-Code-native,
...
| OpenHands | browser-evidence subsystem behind a larger orchestration runtime | [API Builder Quickstart](api-builder-quickstart.md) | Webaudit replacing the outer runtime |
...
> Webaudit is browser automation **for** coding agents, not a coding agent
> replacement.
...
2. [Webaudit MCP Server README](../../apps/mcp-server/README.md)
3. `pnpm mcp:check`
...
That is exactly where Webaudit fits, whether the outer shell is Codex,
...
2. [Webaudit for AI Agents](webaudit-for-ai-agents.md)
3. this page
