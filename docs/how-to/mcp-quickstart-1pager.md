...
Webaudit uses MCP as a **governed integration surface for AI clients**.
...
- you want an external AI client to call Webaudit through tools
  instead of raw REST or shell
- you still want the browser, evidence, and recovery substrate to stay governed

If you are still deciding whether Webaudit itself fits your category, read
...
It matters because it lets an external AI client consume Webaudit as a
...
- another tool-using AI agent needs Webaudit to stay the browser-evidence
...
In Webaudit, MCP is useful because it lets an external AI client:
...
Webaudit does **not** claim an official Codex-only or Claude Code-only MCP
integration.

The truthful claim is:

- if your coding agent already speaks tools, Webaudit's MCP server can act as
...
- Webaudit stays the browser-evidence and recovery substrate
...
| let an external AI client call governed tools | [Webaudit MCP Server README](../../apps/mcp-server/README.md) | MCP is the governed tool layer |
...
2. read the [Webaudit MCP Server README](../../apps/mcp-server/README.md)
...
1. [Webaudit for AI Agents](webaudit-for-ai-agents.md)
2. [Webaudit for Coding Agents and Agent Ecosystems](webaudit-for-coding-agents.md)
...
5. [Webaudit MCP Server README](../../apps/mcp-server/README.md)
