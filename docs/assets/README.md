...
This directory documents the reviewable source assets for Webaudit's public
storefront.
...
- `../../assets/storefront/webaudit-readme-hero.svg`
...
- `../../assets/storefront/webaudit-agent-ecosystem-map.svg`
  ...
  - Message: which named ecosystems are MCP-first, API-first, or hybrid while Webaudit stays the browser-evidence layer
...
- Upload `../../assets/storefront/webaudit-social-preview.png` in GitHub
